        ...
        <form class="space-y-6">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="tel" class="w-full px-4 py-2 rounded-lg border focus:ring-2 focus:ring-primary" />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea rows="4" required class="w-full px-4 py-2 rounded-lg border focus:ring-2 focus:ring-primary"
              placeholder="Escribe tus comentarios..."></textarea>
          </div>

          <button type="submit" class="w-full sm:w-auto px-8 py-3 bg-primary text-white rounded-lg hover:bg-primary-dark 
